...
from autolens.imaging.fit_imaging import FitImaging, FitImagingReducedChi
...
class AnalysisImagingReducedChi(AnalysisDataset):
    Result = ResultImaging
    Visualizer = VisualizerImaging
    def modify_before_fit(self, paths: af.DirectoryPaths, model: af.Collection):
        """
